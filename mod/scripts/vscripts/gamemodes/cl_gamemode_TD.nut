global function ClGamemodeTD_SOLO_Init
global function ClGamemodeTD_LOBBY_Init
...
void function ClGamemodeTD_SOLO_Init()
{
...
void function Cl_OnWaitingVote(float TimeToWait) {
    Chat_GameWriteLine("\x1b[113m" + Localize("#TD_LOBBY_WaitingVoteTimeLeft", TimeToWait ))
}

void function Cl_EnoughPlayerToStart(float TimeBeforeStart) {
    Chat_GameWriteLine("\x1b[113m" + Localize("#TD_LOBBY_GameStartChatAnnouncement", TimeBeforeStart ))
}

void function GameNumPlayerLeftAnnouncement(int NumPlayer)
{   
    AnnouncementData announcement = Announcement_Create(Localize ("#TD_SOLO_GameNumPlayerLeftAnnouncement", NumPlayer ))
...
void function ClGamemodeTD_LOBBY_Init()
{
